...
namespace ExtraDetailingTools.Systems.Tools
{
    public partial class GrassToolSystem : ToolBaseSystem
    {
        ...
        internal static GrassToolSystem s_Instance;
        internal ToolSystem toolSystem;
        ...
        protected override void OnCreate()
        {
            ...
            int index  = m_ToolSystem.tools.IndexOf(objectToolSystem);
	...
	[BurstCompile]
        ...
        private struct CreateDefinitionsJob : IJob
        {
            public void Execute()
            {
                ...
                GrassBrushData grassBrushData = default;
                grassBrushData.m_State = m_State;
                this.m_CommandBuffer.AddComponent<GrassBrushData>(m_Prefab, grassBrushData);
